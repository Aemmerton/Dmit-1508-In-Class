...
-- Start with comments as done below in question 1, Set if else to prompt potential errors
...
EXEC DissolveClub 'CIPS' -- Should now fail because the club doesn't exist anymore
